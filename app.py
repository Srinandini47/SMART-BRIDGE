"""
Smart Bridge - AI Powered Produce Quality Classifier
========================================================
Author: Shaik Thasmiya 
GitHub: https://github.com/ShaikThasmiya26
Repository:https://github.com/ShaikThasmiya26/Smart-bridge
Description:
An AI-powered web application that detects whether fruits and vegetables
are fresh or rotten using deep learning (VGG16) transfer learning.
Built with Flask backend and modern UI for instant quality analysis.

Technologies: Python, Flask, TensorFlow, VGG16, HTML/CSS, JavaScript
Deployment: Render
"""
